    ...
    <footer className="bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 py-10 px-10 font-sans tracking-wide mt-auto">
      ...
      <ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-3 gap-12 mt-10 justify-items-center">
        <li className="flex items-center">
          ...
          <a href="tel:037052051212" className="text-blue-500 text-sm ml-3">
        ...
        <li className="flex items-center">
          ...
          <a href="mailto:info@winbas.eu" className="text-blue-500 text-sm ml-3">
        ...
        <li className="flex items-center">
          ...
          <a href="https://maps.app.goo.gl/NKMz5hhASWKzasDz9" className="text-blue-500 text-sm ml-3" target="_blank">
      ...
      <div className="flex max-md:flex-col gap-4">
        ...
        <p className="text-sm text-gray-200 md:ml-auto">© 2022, UAB "WinBas" Žalgirio g. 90c, LT-09303 Vilnius info@winbas.eu +370 52051212</p>
      </div>
    </footer>
  );
}
