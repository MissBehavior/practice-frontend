        ...
        <div>
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <MdDeleteForever className="relative top-0 right-0 w-[40px] p-1 h-[40px] rounded-md bg-red-500 shadow-lg transition-all transform duration-150 hover:scale-105 cursor-pointer" />
                </DialogTrigger>
