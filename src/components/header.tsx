    ...
    <header className="shadow-md bg-white dark:bg-gray-800 font-sans tracking-wide relative z-50">
      <section className="flex items-center lg:justify-center flex-wrap gap-5 relative py-3 px-10 border-gray-200 border-b dark:border-gray-700 lg:min-h-[80px] max-lg:min-h-[60px]">
        <a href="javascript:void(0)">
          <img src={companyLogo} alt="logo" className="md:w-[170px] w-36" />
        </a>
        <div className="space-x-6 md:absolute md:right-10 flex items-center max-md:ml-auto">
          <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer fill-black dark:fill-white" width="20px" height="20px" viewBox="0 0 512 512">
            <path
          ...
          <div className="inline-block border-gray-300 border-l-2 dark:border-gray-600 pl-5 cursor-pointer h-[40px] flex flex-row items-center justify-center gap-2">
            <a onClick={setLanguage("en")}>EN</a>|<a onClick={setLanguage("lt")}>LT</a>
          </div>
      ...
      <div className="flex flex-wrap py-3.5 px-10 overflow-x-auto">
        <div id="collapseMenu" style={{ display: isMenuOpen ? "block" : "none" }} className="w-full max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50">
          <button id="toggleClose" onClick={handleClick} className="lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white dark:bg-gray-700 p-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 fill-black dark:fill-white" viewBox="0 0 320.591 320.591">
          ...
          <ul className="lg:flex lg:justify-center lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-white dark:max-lg:bg-gray-800 max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
            ...
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/" className="hover:text-[#007bff] text-[#007bff] dark:text-[#007bff] font-bold text-[15px] block">
                {t("home")}
              </Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/about" className="hover:text-[#007bff] text-gray-500 dark:text-gray-300 font-bold text-[15px] block">
                {t("about_us")}
              </Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/solutions" className="hover:text-[#007bff] text-gray-500 dark:text-gray-300 font-bold text-[15px] block">
                {t("solutions")}
              </Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/people" className="hover:text-[#007bff] text-gray-500 dark:text-gray-300 font-bold text-[15px] block">
                {t("people")}
              </Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/gallery" className="hover:text-[#007bff] text-gray-500 dark:text-gray-300 font-bold text-[15px] block">
                {t("gallery")}
              </Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/career" className="hover:text-[#007bff] text-gray-500 dark:text-gray-300 font-bold text-[15px] block">
                {t("career")}
              </Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/clients" className="hover:text-[#007bff] text-gray-500 dark:text-gray-300 font-bold text-[15px] block">
                {t("clients")}
              </Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 dark:max-lg:border-gray-600 max-lg:py-3">
              <Link to="/post-external" className="hover:text-[#007bff] text-gray-500 dark:text-gray-300 font-bold text-[15px] block">
                {t("post_external")}
              </Link>
            </li>
          </ul>
